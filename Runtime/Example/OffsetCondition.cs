...
{
    /// <summary>
    /// When this observer condition is placed on an object, a client must be within the specified real distance to view the object.
    /// </summary>
    [CreateAssetMenu(fileName = "OffsetCondition", menuName = "FloatingOffset/OffsetCondition", order = 1)]
    public class OffsetCondition : ObserverCondition
    {
        #region Serialized.
        /// <summary>
        /// </summary>
