...
//TODO add obsolete everywhere to help people who are trying to refactor
namespace FishNet.FloatingOrigin
{
    [RequireComponent(typeof(IOffsetter))]
    [Obsolete("Refactored, replace with OffsetManager, and add OffsetScene to all scenes that the OffsetManager should manage.", true)]
