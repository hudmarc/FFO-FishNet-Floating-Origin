...
namespace FishNet.FloatingOrigin
{
    ...
    {
        const string HEX = "X";
        //TODO REIMPLEMENT: public static Vector3d GetRealPosition(this Transform transform) => FOManager.instance.UnityToReal(transform.position, transform.gameObject.scene);
